...
<Link to={`/Appliedjob`}> <div className='frametext'>Interviewing </div></Link>
            <div className='frametext'></div></div>
...
{ele.jobcode}-{ele.jobtitle}-{ele.companyname}<button className='apply7' onClick={()=>sendData(ele)}>apply</button><br></br>
